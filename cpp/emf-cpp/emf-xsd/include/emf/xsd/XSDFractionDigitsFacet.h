// EMF XSD: XSDFractionDigitsFacet
// 对齐 Java: org.eclipse.xsd.XSDFractionDigitsFacet
#pragma once
...
class XSDFractionDigitsFacet : public XSDFixedFacet {
public:
    XSDFractionDigitsFacet() = default;
    ~XSDFractionDigitsFacet() override = default;
