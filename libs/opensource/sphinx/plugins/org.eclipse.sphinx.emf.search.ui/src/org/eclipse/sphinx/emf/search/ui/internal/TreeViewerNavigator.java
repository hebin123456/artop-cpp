...
public class TreeViewerNavigator implements INavigate {
	...
	private ModelSearchResultViewPage searchResultViewPage;

	public TreeViewerNavigator(ModelSearchResultViewPage page, TreeViewer viewer) {
		this.viewer = viewer;
		searchResultViewPage = page;
	}
	...
	private boolean hasMatches(TreeItem item) {
		...
		return searchResultViewPage.getDisplayedMatchCount(element) > 0;
	}
