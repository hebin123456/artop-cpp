...
public final class ReflectUtil {
	 ...
	 *         Super Interface of the given class, return <code>null</code> if there isn't such a field in the given
	 ...
	 * @throws IllegalAccessException
	 */
	public static Object getInvisibleFieldValue(Object object, String fieldName) throws NoSuchFieldException, IllegalArgumentException,
	 ...
	 * @return <code>Method</code> that has the given name and given parameter types. Return <code>null</code> if there
	 *         is no method like that
	 */
	public static Method findDeclaredMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
		Assert.isNotNull(clazz);

		for (Method declaredMethod : clazz.getDeclaredMethods()) {
			if (declaredMethod.getName().equals(methodName) && compareParameterTypes(declaredMethod.getParameterTypes(), parameterTypes)) {
	...
	public static Object invokeMethod(Object object, String methodName, Object... args) throws NoSuchMethodException, IllegalAccessException,
		...
		if (method == null) {
			throw new NoSuchMethodException(clazz.getName() + "#" + methodName + "(" + convertParameterTypesToString(parameterTypes) + ")"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
	 ...
	 * @throws InvocationTargetException
	 */
	public static Object invokeInvisibleMethod(Object object, String methodName, Object... args) throws NoSuchMethodException,
	 ...
	 *            the object whose fields are to be cleared
	 * @param clazz
	 *            the class or interface indicating the declared and inherited fields which are to be cleared on the
	 *            given object
	 * @param excludedFieldNames
	 *            the names of the fields that are to be excluded from clearing
	 * @throws IllegalAccessException
	...
	private static void clearDeclaredFields(Object object, Class<?> clazz, String[] excludedFieldNames) throws IllegalAccessException {
		...
		List<String> excludedFieldNameList = excludedFieldNames != null ? Arrays.asList(excludedFieldNames) : new ArrayList<String>(0);
		for (Field declaredField : clazz.getDeclaredFields()) {
