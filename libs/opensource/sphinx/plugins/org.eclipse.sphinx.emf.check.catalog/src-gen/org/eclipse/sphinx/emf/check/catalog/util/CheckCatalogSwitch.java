...
public class CheckCatalogSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CheckCatalogPackage.IDENTIFIABLE: {
				Identifiable identifiable = (Identifiable)theEObject;
				T result = caseIdentifiable(identifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CheckCatalogPackage.CATALOG: {
				Catalog catalog = (Catalog)theEObject;
				T result = caseCatalog(catalog);
				if (result == null) result = caseIdentifiable(catalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CheckCatalogPackage.CONSTRAINT: {
			...
			case CheckCatalogPackage.CATEGORY: {
