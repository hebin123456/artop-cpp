...
public class FieldSeverityAndMessage extends FieldMessage {
	...
	public Image getImage(Object obj) {
		...
		try {
			return JFaceResources.getResources()
					.createImage(SphinxValidationUiActivator.getDefault().getImageDescriptor(SphinxValidationUiActivator.IMG_ETOOL_PROBLEM_CATEGORY));
	...
	public Image getColumnHeaderImage() {
		return getImage(SphinxValidationUiActivator.IMG_OBJS_HEADER_COMPLETE);
	}
