...
public final class Util {
	...
	public static void log(CoreException exception) {
		SphinxValidationUiActivator.log(exception.getLocalizedMessage(), exception);
	}
	...
	public static IStatus errorStatus(Throwable exception) {
		...
		return new Status(IStatus.ERROR, SphinxValidationUiActivator.getPluginId(), IStatus.ERROR, message, exception);
	}
	...
	public static Image getImage(int severity) {
		...
		if (severity == IMarker.SEVERITY_ERROR) {
			return getIDEImage(SphinxValidationUiActivator.IMG_OBJS_ERROR_PATH);
		}
		if (severity == IMarker.SEVERITY_WARNING) {
			return getIDEImage(SphinxValidationUiActivator.IMG_OBJS_WARNING_PATH);
		}
		if (severity == IMarker.SEVERITY_INFO) {
			return getIDEImage(SphinxValidationUiActivator.IMG_OBJS_INFO_PATH);
		}
	...
	private static Image getIDEImage(String constantName) {
		...
		return JFaceResources.getResources().createImageWithDefault(SphinxValidationUiActivator.getDefault().getImageDescriptor(constantName));
