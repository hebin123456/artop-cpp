...
public class InterfacesItemProvider extends TransientItemProvider {
	...
	public String getText(Object object) {
		return Messages.label_Interfaces_TansientNode;
	}

	@Override
	public Object getStyledText(Object object) {
		return new StyledString(getText(object), IHummingbird20Styles.TYPE_GROUP_STYLE);
	}
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location, int operations, int operation,
		...
		if (new AddCommand(domain, (EObject) owner, TypeModel20Package.Literals.PLATFORM__INTERFACES, collection).canExecute()) {
