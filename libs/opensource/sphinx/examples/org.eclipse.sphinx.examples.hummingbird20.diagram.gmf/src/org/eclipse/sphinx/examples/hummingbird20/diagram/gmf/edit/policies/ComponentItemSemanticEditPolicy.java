...
import org.eclipse.sphinx.examples.hummingbird20.diagram.gmf.edit.commands.ConnectionCreateCommand;
import org.eclipse.sphinx.examples.hummingbird20.diagram.gmf.edit.commands.ConnectionReorientCommand;
 ...
 * @generated
 */
public class ComponentItemSemanticEditPolicy extends Hummingbird20BaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ComponentItemSemanticEditPolicy() {
		super(Hummingbird20ElementTypes.Component_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Hummingbird20VisualIDRegistry.getVisualID(incomingLink) == ConnectionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Hummingbird20VisualIDRegistry.getVisualID(outgoingLink) == ConnectionEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (Hummingbird20ElementTypes.Connection_4001 == req.getElementType()) {
