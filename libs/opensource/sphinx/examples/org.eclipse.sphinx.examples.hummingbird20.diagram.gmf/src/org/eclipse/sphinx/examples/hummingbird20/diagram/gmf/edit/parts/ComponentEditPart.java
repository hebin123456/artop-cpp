...
import org.eclipse.sphinx.examples.hummingbird20.diagram.gmf.edit.policies.ComponentItemSemanticEditPolicy;
...
public class ComponentEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentNameEditPart) {
			((ComponentNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureComponentLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Hummingbird20VisualIDRegistry.getType(ComponentNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(Hummingbird20ElementTypes.Connection_4001);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.sphinx.examples.hummingbird20.diagram.gmf.edit.parts.ComponentEditPart) {
			types.add(Hummingbird20ElementTypes.Connection_4001);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == Hummingbird20ElementTypes.Connection_4001) {
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 245, 223, 181);
