...
/**
 * This is the item provider adapter for a {@link org.eclipse.sphinx.examples.hummingbird10.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_name_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_name_feature", "_UI_Component_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 Hummingbird10Package.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hummingbird10Package.Literals.COMPONENT__PROVIDED_INTERFACES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hummingbird10Package.Literals.COMPONENT__INCOMING_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Hummingbird10Package.Literals.COMPONENT__OUTGOING_CONNECTIONS,
				 Hummingbird10Factory.eINSTANCE.createConnection()));

		newChildDescriptors.add
			(createChildParameter
				(Hummingbird10Package.Literals.COMPONENT__PARAMETERS,
