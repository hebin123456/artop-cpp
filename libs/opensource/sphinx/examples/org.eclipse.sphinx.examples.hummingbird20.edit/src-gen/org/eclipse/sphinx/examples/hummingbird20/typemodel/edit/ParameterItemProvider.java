 ...
 * @generated
 */
public class ParameterItemProvider extends IdentifiableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_dataType_feature"), //$NON-NLS-1$
				 ...
				 TypeModel20Package.Literals.PARAMETER__DATA_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypeModel20Package.Literals.PARAMETER__OPTIONAL,
				 true,
				 false,
				 false,
