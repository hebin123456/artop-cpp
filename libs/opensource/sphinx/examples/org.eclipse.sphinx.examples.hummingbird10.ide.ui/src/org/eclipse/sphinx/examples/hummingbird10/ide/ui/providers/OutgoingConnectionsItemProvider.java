...
public class OutgoingConnectionsItemProvider extends TransientItemProvider {
	...
	public String getText(Object object) {
		return Messages.label_OutgoingConnetion_TransientNode;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Hummingbird10Package.Literals.COMPONENT__OUTGOING_CONNECTIONS,
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location, int operations, int operation,
		...
		if (new AddCommand(domain, (EObject) owner, Hummingbird10Package.Literals.COMPONENT__OUTGOING_CONNECTIONS, collection).canExecute()) {
