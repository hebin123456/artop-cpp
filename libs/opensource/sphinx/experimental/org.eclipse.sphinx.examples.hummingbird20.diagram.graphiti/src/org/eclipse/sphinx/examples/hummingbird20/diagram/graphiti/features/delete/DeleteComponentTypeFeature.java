...
public class DeleteComponentTypeFeature extends DefaultDeleteFeature {

	public DeleteComponentTypeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void delete(IDeleteContext context) {
		...
		if (eObject instanceof ComponentType) {
			ComponentType componentToRemove = (ComponentType) eObject;
			// Remove the link from the EMF resource
			DiagramUtil.deleteObjectFromBOResource(componentToRemove);
