...
public class DeleteRequiredInterfacesFeature extends DefaultDeleteFeature {

	public DeleteRequiredInterfacesFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void delete(IDeleteContext context) {
		...
		// deleting business object Port because in our implementation, the container shape of connection
		// "requiredIntefaces" is not linked to an EClass, it is linked to a Port, and we don't want to delete
		// the Port cf. http://www.eclipse.org/forums/index.php/t/172976/
	...
	public void deleteLinkFromEMFResource(IDeleteContext context) {
		...
		PictogramElement sourceShape = connection.getStart();
