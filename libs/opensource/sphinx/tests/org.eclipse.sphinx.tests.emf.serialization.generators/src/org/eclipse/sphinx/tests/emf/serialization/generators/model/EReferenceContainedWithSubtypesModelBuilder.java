...
public class EReferenceContainedWithSubtypesModelBuilder extends AbstractNodeModelBuilder {

	public EReferenceContainedWithSubtypesModelBuilder(String name, int persistenceMappingStrategy) {
	...
	protected List<EPackage> createMetaModel(String name, boolean isMany, int persistenceMappingStrategy) {
		...
		// create sub node first in order to check if global elements are ordered alphabetically in the XSD
