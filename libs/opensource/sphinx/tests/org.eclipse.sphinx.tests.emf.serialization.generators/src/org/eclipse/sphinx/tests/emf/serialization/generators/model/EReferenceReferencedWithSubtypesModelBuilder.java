...
public class EReferenceReferencedWithSubtypesModelBuilder extends AbstractNodeModelBuilder {

	public EReferenceReferencedWithSubtypesModelBuilder(String name, int persistenceMappingStrategy) {
	...
	protected List<EPackage> createMetaModel(String name, boolean isMany, int persistenceMappingStrategy) {
		...
		EClass subNodeEClass = createEClass(ePackage, "SubNode", "SUB-NODE", "SUB-NODES", false);
