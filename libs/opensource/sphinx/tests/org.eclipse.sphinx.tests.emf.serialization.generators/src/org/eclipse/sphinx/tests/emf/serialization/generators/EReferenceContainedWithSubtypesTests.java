...
import org.eclipse.sphinx.tests.emf.serialization.generators.model.EReferenceContainedWithSubtypesModelBuilder;
import org.eclipse.sphinx.tests.emf.serialization.generators.model.ModelBuilder;
import org.junit.Test;

public class EReferenceContainedWithSubtypesTests extends AbstractEReferenceContainedTestCase {

	@Override
	protected ModelBuilder getModelBuilder(String name, int persistenceMappingStrategy) {
		return new EReferenceContainedWithSubtypesModelBuilder(name, persistenceMappingStrategy);
	}
