...
public class EAttributeContainedXMLTypesDataTypesModelBuilder extends AbstractNodeModelBuilder {

	public EAttributeContainedXMLTypesDataTypesModelBuilder(String name, int persistenceMappingStrategy) {
	...
	protected List<EPackage> createMetaModel(String name, boolean isMany, int persistenceMappingStrategy) {
		...
		EDataType stringEDataType = XMLTypePackage.eINSTANCE.getString();
