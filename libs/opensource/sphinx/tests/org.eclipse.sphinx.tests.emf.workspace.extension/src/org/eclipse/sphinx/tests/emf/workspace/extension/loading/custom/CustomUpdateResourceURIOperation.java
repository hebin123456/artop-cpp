...
public class CustomUpdateResourceURIOperation extends DefaultUpdateResourceURIOperation {

	public CustomUpdateResourceURIOperation(Map<IFile, IPath> filesToUpdate) {
		super(filesToUpdate);
	}
}
