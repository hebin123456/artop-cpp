...
public class CustomFileReloadOperation extends DefaultFileReloadOperation {

	public CustomFileReloadOperation(Collection<IFile> files, IMetaModelDescriptor mmDescriptor, boolean memoryOptimized) {
