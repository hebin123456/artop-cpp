 ...
 * </copyright>
 */
package org.eclipse.sphinx.tests.emf.serialization.load;
...
public class BasicLoadTests extends AbstractTestCase {
	...
	static final String INPUT_PATH = "org.eclipse.sphinx.tests.emf.serialization.load/";
	...
	@Test
	public void testEReference_Contained1100_Many() {
		String inputFileName = INPUT_PATH + "EReference_Contained1100Many.xml";
		try {
			EObject modelRoot = loadInputFile(inputFileName, new XMLPersistenceMappingResourceFactoryImpl(), null);
			validateModelMulti(modelRoot, NodesPackage.eINSTANCE.getNode_EReference_Contained1100Many(),
					NodesPackage.eINSTANCE.getNode_EReference_Contained0100Many());
		} catch (Exception ex) {
			assertTrue(ex.getMessage(), false);
		}
	...
	@Test
	public void testEReference_Contained1100_Single() {
		String inputFileName = INPUT_PATH + "EReference_Contained1100Single.xml";
		try {
			EObject modelRoot = loadInputFile(inputFileName, new XMLPersistenceMappingResourceFactoryImpl(), null);
			validateModelSingle(modelRoot, NodesPackage.eINSTANCE.getNode_EReference_Contained1100Single(),
					NodesPackage.eINSTANCE.getNode_EReference_Contained0100Single());
		} catch (Exception ex) {
			assertTrue(ex.getMessage(), false);
		}
