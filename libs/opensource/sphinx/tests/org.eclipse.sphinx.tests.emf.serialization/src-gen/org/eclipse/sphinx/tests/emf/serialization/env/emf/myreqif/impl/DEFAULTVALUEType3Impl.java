...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type3</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUEType3Impl#getATTRIBUTEVALUEREAL <em>
...
public class DEFAULTVALUEType3Impl extends EObjectImpl implements DEFAULTVALUEType3 {
	...
	public NotificationChain basicSetATTRIBUTEVALUEREAL(ATTRIBUTEVALUEREAL newATTRIBUTEVALUEREAL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL,
					oldATTRIBUTEVALUEREAL, newATTRIBUTEVALUEREAL);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEREAL(ATTRIBUTEVALUEREAL newATTRIBUTEVALUEREAL) {
		if (newATTRIBUTEVALUEREAL != aTTRIBUTEVALUEREAL) {
			...
			if (aTTRIBUTEVALUEREAL != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEREAL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, null, msgs);
			}
			if (newATTRIBUTEVALUEREAL != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEREAL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, newATTRIBUTEVALUEREAL,
					newATTRIBUTEVALUEREAL));
		}
	}
