...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type3</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType3Impl#getDATATYPEDEFINITIONSTRINGREF <em>
...
public class TYPEType3Impl extends EObjectImpl implements TYPEType3 {
	/**
	 * The default value of the '{@link #getDATATYPEDEFINITIONSTRINGREF() <em>DATATYPEDEFINITIONSTRINGREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getDATATYPEDEFINITIONSTRINGREF() <em>DATATYPEDEFINITIONSTRINGREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDATATYPEDEFINITIONSTRINGREF()
	 * @generated
	...
	public void setDATATYPEDEFINITIONSTRINGREF(String newDATATYPEDEFINITIONSTRINGREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE3__DATATYPEDEFINITIONSTRINGREF,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.TYPE_TYPE3__DATATYPEDEFINITIONSTRINGREF:
			return DATATYPEDEFINITIONSTRINGREF_EDEFAULT == null ? dATATYPEDEFINITIONSTRINGREF != null : !DATATYPEDEFINITIONSTRINGREF_EDEFAULT
