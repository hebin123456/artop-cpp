...
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONENUMERATION;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DATATYPEDEFINITIONENUMERATION</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getALTERNATIVEID
 * <em>ALTERNATIVEID</em>}</li>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getSPECIFIEDVALUES
 * <em>SPECIFIEDVALUES</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getDESC <em>
 * DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getIDENTIFIER
 * <em>IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getLASTCHANGE
 * <em>LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONENUMERATIONImpl#getLONGNAME
 * <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
...
public class DATATYPEDEFINITIONENUMERATIONImpl extends EObjectImpl implements DATATYPEDEFINITIONENUMERATION {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType1 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MyreqifPackage.DATATYPEDEFINITIONENUMERATION__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DATATYPEDEFINITIONENUMERATION__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONENUMERATION__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
	...
	public NotificationChain basicSetSPECIFIEDVALUES(SPECIFIEDVALUESType newSPECIFIEDVALUES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MyreqifPackage.DATATYPEDEFINITIONENUMERATION__SPECIFIEDVALUES, oldSPECIFIEDVALUES, newSPECIFIEDVALUES);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setSPECIFIEDVALUES(SPECIFIEDVALUESType newSPECIFIEDVALUES) {
		if (newSPECIFIEDVALUES != sPECIFIEDVALUES) {
			...
			if (sPECIFIEDVALUES != null) {
				msgs = ((InternalEObject) sPECIFIEDVALUES).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DATATYPEDEFINITIONENUMERATION__SPECIFIEDVALUES, null, msgs);
			}
			if (newSPECIFIEDVALUES != null) {
				msgs = ((InternalEObject) newSPECIFIEDVALUES).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DATATYPEDEFINITIONENUMERATION__SPECIFIEDVALUES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONENUMERATION__SPECIFIEDVALUES, newSPECIFIEDVALUES,
					newSPECIFIEDVALUES));
		}
	}
