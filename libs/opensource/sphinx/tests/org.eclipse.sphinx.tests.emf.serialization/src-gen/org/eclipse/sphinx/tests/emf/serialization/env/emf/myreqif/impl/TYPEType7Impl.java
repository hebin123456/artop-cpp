...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type7</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType7Impl#getSPECRELATIONTYPEREF <em>
...
public class TYPEType7Impl extends EObjectImpl implements TYPEType7 {
	...
	public void setSPECRELATIONTYPEREF(String newSPECRELATIONTYPEREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE7__SPECRELATIONTYPEREF, oldSPECRELATIONTYPEREF,
					sPECRELATIONTYPEREF));
		}
	}
