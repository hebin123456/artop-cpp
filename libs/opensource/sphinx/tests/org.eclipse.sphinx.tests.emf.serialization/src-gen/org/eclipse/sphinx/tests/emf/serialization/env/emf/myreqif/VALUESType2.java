...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>VALUES Type2</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEBOOLEAN <em>
 * ATTRIBUTEVALUEBOOLEAN</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEDATE <em>
 * ATTRIBUTEVALUEDATE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEENUMERATION <em>
 * ATTRIBUTEVALUEENUMERATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEINTEGER <em>
 * ATTRIBUTEVALUEINTEGER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEREAL <em>
 * ATTRIBUTEVALUEREAL</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUESTRING <em>
 * ATTRIBUTEVALUESTRING</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType2#getATTRIBUTEVALUEXHTML <em>
 * ATTRIBUTEVALUEXHTML</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2()
...
public interface VALUESType2 extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_Group()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEBOOLEAN()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEDATE()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEENUMERATION()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEINTEGER()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEREAL()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUESTRING()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType2_ATTRIBUTEVALUEXHTML()
	 * @model containment="true" transient="true" volatile="true" derived="true"
