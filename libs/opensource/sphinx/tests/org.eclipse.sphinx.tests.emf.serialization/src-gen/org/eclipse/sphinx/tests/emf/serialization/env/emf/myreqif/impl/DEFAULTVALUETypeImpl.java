...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUETypeImpl#getATTRIBUTEVALUEDATE <em>
...
public class DEFAULTVALUETypeImpl extends EObjectImpl implements DEFAULTVALUEType {
	...
	public NotificationChain basicSetATTRIBUTEVALUEDATE(ATTRIBUTEVALUEDATE newATTRIBUTEVALUEDATE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE__ATTRIBUTEVALUEDATE,
					oldATTRIBUTEVALUEDATE, newATTRIBUTEVALUEDATE);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEDATE(ATTRIBUTEVALUEDATE newATTRIBUTEVALUEDATE) {
		if (newATTRIBUTEVALUEDATE != aTTRIBUTEVALUEDATE) {
			...
			if (aTTRIBUTEVALUEDATE != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEDATE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE__ATTRIBUTEVALUEDATE, null, msgs);
			}
			if (newATTRIBUTEVALUEDATE != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEDATE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE__ATTRIBUTEVALUEDATE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE__ATTRIBUTEVALUEDATE, newATTRIBUTEVALUEDATE,
					newATTRIBUTEVALUEDATE));
		}
	}
