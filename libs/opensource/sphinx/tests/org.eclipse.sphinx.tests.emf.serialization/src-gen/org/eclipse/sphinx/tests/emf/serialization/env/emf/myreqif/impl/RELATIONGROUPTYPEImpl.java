...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>RELATIONGROUPTYPE</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getSPECATTRIBUTES <em>
 * SPECATTRIBUTES</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getIDENTIFIER <em>
 * IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getLASTCHANGE <em>
 * LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPTYPEImpl#getLONGNAME <em>LONGNAME
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class RELATIONGROUPTYPEImpl extends EObjectImpl implements RELATIONGROUPTYPE {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType5 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUPTYPE__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUPTYPE__ALTERNATIVEID, null, msgs);
			}
	...
	public NotificationChain basicSetSPECATTRIBUTES(SPECATTRIBUTESType3 newSPECATTRIBUTES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUPTYPE__SPECATTRIBUTES,
		...
		if (newSPECATTRIBUTES != sPECATTRIBUTES) {
			...
			if (sPECATTRIBUTES != null) {
				msgs = ((InternalEObject) sPECATTRIBUTES).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUPTYPE__SPECATTRIBUTES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUPTYPE__SPECATTRIBUTES, newSPECATTRIBUTES,
					newSPECATTRIBUTES));
		}
	}
