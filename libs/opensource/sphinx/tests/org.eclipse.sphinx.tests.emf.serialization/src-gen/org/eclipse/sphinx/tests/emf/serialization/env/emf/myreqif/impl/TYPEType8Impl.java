...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type8</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType8Impl#getDATATYPEDEFINITIONDATEREF <em>
 * DATATYPEDEFINITIONDATEREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TYPEType8Impl extends EObjectImpl implements TYPEType8 {
	...
	public void setDATATYPEDEFINITIONDATEREF(String newDATATYPEDEFINITIONDATEREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE8__DATATYPEDEFINITIONDATEREF, oldDATATYPEDEFINITIONDATEREF,
					dATATYPEDEFINITIONDATEREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.TYPE_TYPE8__DATATYPEDEFINITIONDATEREF:
			return DATATYPEDEFINITIONDATEREF_EDEFAULT == null ? dATATYPEDEFINITIONDATEREF != null : !DATATYPEDEFINITIONDATEREF_EDEFAULT
					.equals(dATATYPEDEFINITIONDATEREF);
		}
