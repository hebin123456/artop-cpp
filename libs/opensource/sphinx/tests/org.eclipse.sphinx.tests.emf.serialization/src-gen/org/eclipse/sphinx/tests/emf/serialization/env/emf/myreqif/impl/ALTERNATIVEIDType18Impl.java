...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ALTERNATIVEID Type18</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ALTERNATIVEIDType18Impl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * </ul>
 * </p>
 *
...
public class ALTERNATIVEIDType18Impl extends EObjectImpl implements ALTERNATIVEIDType18 {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEID newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE18__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ALTERNATIVEID_TYPE18__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE18__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
