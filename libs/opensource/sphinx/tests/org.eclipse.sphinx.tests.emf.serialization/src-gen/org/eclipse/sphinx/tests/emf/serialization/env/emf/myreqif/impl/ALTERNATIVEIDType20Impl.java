...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ALTERNATIVEID Type20</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ALTERNATIVEIDType20Impl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * </ul>
 * </p>
 *
...
public class ALTERNATIVEIDType20Impl extends EObjectImpl implements ALTERNATIVEIDType20 {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEID newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE20__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ALTERNATIVEID_TYPE20__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE20__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
