...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type1</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUEType1Impl#getATTRIBUTEVALUEENUMERATION
 * <em>ATTRIBUTEVALUEENUMERATION</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType1Impl extends EObjectImpl implements DEFAULTVALUEType1 {
	/**
	 * The cached value of the '{@link #getATTRIBUTEVALUEENUMERATION() <em>ATTRIBUTEVALUEENUMERATION</em>}' containment
	...
	public NotificationChain basicSetATTRIBUTEVALUEENUMERATION(ATTRIBUTEVALUEENUMERATION newATTRIBUTEVALUEENUMERATION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MyreqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, oldATTRIBUTEVALUEENUMERATION, newATTRIBUTEVALUEENUMERATION);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEENUMERATION(ATTRIBUTEVALUEENUMERATION newATTRIBUTEVALUEENUMERATION) {
		if (newATTRIBUTEVALUEENUMERATION != aTTRIBUTEVALUEENUMERATION) {
			...
			if (aTTRIBUTEVALUEENUMERATION != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEENUMERATION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, null, msgs);
			}
			if (newATTRIBUTEVALUEENUMERATION != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEENUMERATION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION,
					newATTRIBUTEVALUEENUMERATION, newATTRIBUTEVALUEENUMERATION));
		}
	}
