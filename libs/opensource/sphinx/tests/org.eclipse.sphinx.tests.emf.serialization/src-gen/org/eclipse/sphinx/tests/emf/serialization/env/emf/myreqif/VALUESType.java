...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>VALUES Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEBOOLEAN <em>
 * ATTRIBUTEVALUEBOOLEAN</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEDATE <em>
 * ATTRIBUTEVALUEDATE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEENUMERATION <em>
 * ATTRIBUTEVALUEENUMERATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEINTEGER <em>
 * ATTRIBUTEVALUEINTEGER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEREAL <em>
 * ATTRIBUTEVALUEREAL</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUESTRING <em>
 * ATTRIBUTEVALUESTRING</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.VALUESType#getATTRIBUTEVALUEXHTML <em>
 * ATTRIBUTEVALUEXHTML</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType()
...
public interface VALUESType extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_Group()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEBOOLEAN()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEDATE()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEENUMERATION()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEINTEGER()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEREAL()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUESTRING()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getVALUESType_ATTRIBUTEVALUEXHTML()
	 * @model containment="true" transient="true" volatile="true" derived="true"
