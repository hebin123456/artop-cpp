...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SPECIFICATIONTYPE</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getSPECATTRIBUTES <em>
 * SPECATTRIBUTES</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getIDENTIFIER <em>
 * IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getLASTCHANGE <em>
 * LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECIFICATIONTYPEImpl#getLONGNAME <em>LONGNAME
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class SPECIFICATIONTYPEImpl extends EObjectImpl implements SPECIFICATIONTYPE {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType8 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECIFICATIONTYPE__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.SPECIFICATIONTYPE__ALTERNATIVEID, null, msgs);
			}
	...
	public NotificationChain basicSetSPECATTRIBUTES(SPECATTRIBUTESType1 newSPECATTRIBUTES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECIFICATIONTYPE__SPECATTRIBUTES,
		...
		if (newSPECATTRIBUTES != sPECATTRIBUTES) {
			...
			if (sPECATTRIBUTES != null) {
				msgs = ((InternalEObject) sPECATTRIBUTES).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.SPECIFICATIONTYPE__SPECATTRIBUTES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECIFICATIONTYPE__SPECATTRIBUTES, newSPECATTRIBUTES,
					newSPECATTRIBUTES));
		}
	}
