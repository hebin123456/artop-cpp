...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ALTERNATIVEID Type1</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ALTERNATIVEIDType1Impl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * </ul>
 * </p>
 *
...
public class ALTERNATIVEIDType1Impl extends EObjectImpl implements ALTERNATIVEIDType1 {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEID newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE1__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ALTERNATIVEID_TYPE1__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ALTERNATIVEID_TYPE1__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
