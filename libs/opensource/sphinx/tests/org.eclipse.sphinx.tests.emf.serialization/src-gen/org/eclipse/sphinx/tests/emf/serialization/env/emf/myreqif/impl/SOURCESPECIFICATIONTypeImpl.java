...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SOURCESPECIFICATION Type</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SOURCESPECIFICATIONTypeImpl#getSPECIFICATIONREF
 * <em>SPECIFICATIONREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SOURCESPECIFICATIONTypeImpl extends EObjectImpl implements SOURCESPECIFICATIONType {
	...
	/**
	 * The cached value of the '{@link #getSPECIFICATIONREF() <em>SPECIFICATIONREF</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getSPECIFICATIONREF()
	 * @generated
	...
	public void setSPECIFICATIONREF(String newSPECIFICATIONREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SOURCESPECIFICATION_TYPE__SPECIFICATIONREF, oldSPECIFICATIONREF,
					sPECIFICATIONREF));
		}
	}
