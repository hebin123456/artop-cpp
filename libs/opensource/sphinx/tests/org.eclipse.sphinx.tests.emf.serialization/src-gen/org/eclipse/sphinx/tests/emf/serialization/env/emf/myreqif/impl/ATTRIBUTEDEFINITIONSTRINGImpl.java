...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEDEFINITIONSTRING</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getALTERNATIVEID
 * <em>ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getDEFAULTVALUE
 * <em>DEFAULTVALUE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getTYPE <em>TYPE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getDESC <em>DESC
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getIDENTIFIER <em>
 * IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#isISEDITABLE <em>
 * ISEDITABLE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getLASTCHANGE <em>
 * LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONSTRINGImpl#getLONGNAME <em>
 * LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
...
public class ATTRIBUTEDEFINITIONSTRINGImpl extends EObjectImpl implements ATTRIBUTEDEFINITIONSTRING {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType15 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
	...
	public NotificationChain basicSetDEFAULTVALUE(DEFAULTVALUEType4 newDEFAULTVALUE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__DEFAULTVALUE,
		...
		if (newDEFAULTVALUE != dEFAULTVALUE) {
			...
			if (dEFAULTVALUE != null) {
				msgs = ((InternalEObject) dEFAULTVALUE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__DEFAULTVALUE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__DEFAULTVALUE, newDEFAULTVALUE,
					newDEFAULTVALUE));
		}
	}
	...
	public NotificationChain basicSetTYPE(TYPEType3 newTYPE, NotificationChain msgs) {
		...
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__TYPE, oldTYPE,
					newTYPE);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTYPE(TYPEType3 newTYPE) {
		if (newTYPE != tYPE) {
			NotificationChain msgs = null;
			if (tYPE != null) {
				msgs = ((InternalEObject) tYPE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__TYPE, null,
						msgs);
			}
			if (newTYPE != null) {
				msgs = ((InternalEObject) newTYPE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__TYPE, null,
						msgs);
			}
	...
	public void setISEDITABLE(boolean newISEDITABLE) {
		...
		iSEDITABLEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__ISEDITABLE, oldISEDITABLE, iSEDITABLE,
					!oldISEDITABLEESet));
		}
	}
	...
	public void unsetISEDITABLE() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEDEFINITIONSTRING__ISEDITABLE, oldISEDITABLE,
