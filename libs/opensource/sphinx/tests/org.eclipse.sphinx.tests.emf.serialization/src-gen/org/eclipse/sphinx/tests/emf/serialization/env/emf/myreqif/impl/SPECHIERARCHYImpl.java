...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SPECHIERARCHY</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getCHILDREN <em>CHILDREN</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getEDITABLEATTS <em>
 * EDITABLEATTS</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getOBJECT <em>OBJECT</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getIDENTIFIER <em>IDENTIFIER
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#isISEDITABLE <em>ISEDITABLE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#isISTABLEINTERNAL <em>
 * ISTABLEINTERNAL</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getLASTCHANGE <em>LASTCHANGE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECHIERARCHYImpl#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECHIERARCHYImpl extends EObjectImpl implements SPECHIERARCHY {
	...
	/**
	 * The cached value of the '{@link #getCHILDREN() <em>CHILDREN</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getCHILDREN()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOBJECT() <em>OBJECT</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getOBJECT()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isISTABLEINTERNAL() <em>ISTABLEINTERNAL</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isISTABLEINTERNAL() <em>ISTABLEINTERNAL</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #isISTABLEINTERNAL()
	 * @generated
	...
	/**
	 * This is true if the ISTABLEINTERNAL attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType11 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECHIERARCHY__ALTERNATIVEID,
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType11 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECHIERARCHY__ALTERNATIVEID,
						null, msgs);
			}
			if (newALTERNATIVEID != null) {
				msgs = ((InternalEObject) newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECHIERARCHY__ALTERNATIVEID,
						null, msgs);
			}
	...
	public NotificationChain basicSetCHILDREN(CHILDRENType newCHILDREN, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECHIERARCHY__CHILDREN, oldCHILDREN,
					newCHILDREN);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public NotificationChain basicSetEDITABLEATTS(EDITABLEATTSType newEDITABLEATTS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECHIERARCHY__EDITABLEATTS,
					oldEDITABLEATTS, newEDITABLEATTS);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setEDITABLEATTS(EDITABLEATTSType newEDITABLEATTS) {
		if (newEDITABLEATTS != eDITABLEATTS) {
			...
			if (eDITABLEATTS != null) {
				msgs = ((InternalEObject) eDITABLEATTS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECHIERARCHY__EDITABLEATTS,
						null, msgs);
			}
			if (newEDITABLEATTS != null) {
				msgs = ((InternalEObject) newEDITABLEATTS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECHIERARCHY__EDITABLEATTS,
						null, msgs);
			}
	...
	public void setISEDITABLE(boolean newISEDITABLE) {
		...
		iSEDITABLEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECHIERARCHY__ISEDITABLE, oldISEDITABLE, iSEDITABLE,
					!oldISEDITABLEESet));
		}
	}
	...
	public void unsetISEDITABLE() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.SPECHIERARCHY__ISEDITABLE, oldISEDITABLE, ISEDITABLE_EDEFAULT,
					oldISEDITABLEESet));
		}
	}
	...
	public void setISTABLEINTERNAL(boolean newISTABLEINTERNAL) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECHIERARCHY__ISTABLEINTERNAL, oldISTABLEINTERNAL, iSTABLEINTERNAL,
					!oldISTABLEINTERNALESet));
		}
	}
	...
	public void unsetISTABLEINTERNAL() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.SPECHIERARCHY__ISTABLEINTERNAL, oldISTABLEINTERNAL,
					ISTABLEINTERNAL_EDEFAULT, oldISTABLEINTERNALESet));
		}
	}
