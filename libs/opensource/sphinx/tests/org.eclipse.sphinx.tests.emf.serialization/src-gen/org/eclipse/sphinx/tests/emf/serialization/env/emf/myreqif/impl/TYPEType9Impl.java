...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type9</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType9Impl#getDATATYPEDEFINITIONENUMERATIONREF
 * <em>DATATYPEDEFINITIONENUMERATIONREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TYPEType9Impl extends EObjectImpl implements TYPEType9 {
	/**
	 * The default value of the '{@link #getDATATYPEDEFINITIONENUMERATIONREF()
	 * <em>DATATYPEDEFINITIONENUMERATIONREF</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getDATATYPEDEFINITIONENUMERATIONREF() <em>DATATYPEDEFINITIONENUMERATIONREF</em>}
	...
	public void setDATATYPEDEFINITIONENUMERATIONREF(String newDATATYPEDEFINITIONENUMERATIONREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE9__DATATYPEDEFINITIONENUMERATIONREF,
					oldDATATYPEDEFINITIONENUMERATIONREF, dATATYPEDEFINITIONENUMERATIONREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case MyreqifPackage.TYPE_TYPE9__DATATYPEDEFINITIONENUMERATIONREF:
			return DATATYPEDEFINITIONENUMERATIONREF_EDEFAULT == null ? dATATYPEDEFINITIONENUMERATIONREF != null
					: !DATATYPEDEFINITIONENUMERATIONREF_EDEFAULT.equals(dATATYPEDEFINITIONENUMERATIONREF);
		}
