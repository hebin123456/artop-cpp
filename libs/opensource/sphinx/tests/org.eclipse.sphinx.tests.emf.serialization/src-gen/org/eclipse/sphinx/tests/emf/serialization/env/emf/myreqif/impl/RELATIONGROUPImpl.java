...
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.RELATIONGROUP;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>RELATIONGROUP</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getSOURCESPECIFICATION <em>
 * SOURCESPECIFICATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getSPECRELATIONS <em>
 * SPECRELATIONS</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getTARGETSPECIFICATION <em>
 * TARGETSPECIFICATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getTYPE <em>TYPE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getIDENTIFIER <em>IDENTIFIER
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getLASTCHANGE <em>LASTCHANGE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.RELATIONGROUPImpl#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RELATIONGROUPImpl extends EObjectImpl implements RELATIONGROUP {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType12 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__ALTERNATIVEID,
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType12 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.RELATIONGROUP__ALTERNATIVEID,
						null, msgs);
			}
			if (newALTERNATIVEID != null) {
				msgs = ((InternalEObject) newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.RELATIONGROUP__ALTERNATIVEID,
						null, msgs);
			}
	...
	public NotificationChain basicSetSOURCESPECIFICATION(SOURCESPECIFICATIONType newSOURCESPECIFICATION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__SOURCESPECIFICATION,
					oldSOURCESPECIFICATION, newSOURCESPECIFICATION);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setSOURCESPECIFICATION(SOURCESPECIFICATIONType newSOURCESPECIFICATION) {
		if (newSOURCESPECIFICATION != sOURCESPECIFICATION) {
			...
			if (sOURCESPECIFICATION != null) {
				msgs = ((InternalEObject) sOURCESPECIFICATION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUP__SOURCESPECIFICATION, null, msgs);
			}
			if (newSOURCESPECIFICATION != null) {
				msgs = ((InternalEObject) newSOURCESPECIFICATION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUP__SOURCESPECIFICATION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__SOURCESPECIFICATION, newSOURCESPECIFICATION,
					newSOURCESPECIFICATION));
		}
	}
	...
	public NotificationChain basicSetSPECRELATIONS(SPECRELATIONSType newSPECRELATIONS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__SPECRELATIONS,
	...
	public void setSPECRELATIONS(SPECRELATIONSType newSPECRELATIONS) {
		if (newSPECRELATIONS != sPECRELATIONS) {
			...
			if (sPECRELATIONS != null) {
				msgs = ((InternalEObject) sPECRELATIONS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.RELATIONGROUP__SPECRELATIONS,
						null, msgs);
			}
			if (newSPECRELATIONS != null) {
				msgs = ((InternalEObject) newSPECRELATIONS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.RELATIONGROUP__SPECRELATIONS,
						null, msgs);
			}
	...
	public NotificationChain basicSetTARGETSPECIFICATION(TARGETSPECIFICATIONType newTARGETSPECIFICATION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__TARGETSPECIFICATION,
					oldTARGETSPECIFICATION, newTARGETSPECIFICATION);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setTARGETSPECIFICATION(TARGETSPECIFICATIONType newTARGETSPECIFICATION) {
		if (newTARGETSPECIFICATION != tARGETSPECIFICATION) {
			...
			if (tARGETSPECIFICATION != null) {
				msgs = ((InternalEObject) tARGETSPECIFICATION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUP__TARGETSPECIFICATION, null, msgs);
			}
			if (newTARGETSPECIFICATION != null) {
				msgs = ((InternalEObject) newTARGETSPECIFICATION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.RELATIONGROUP__TARGETSPECIFICATION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.RELATIONGROUP__TARGETSPECIFICATION, newTARGETSPECIFICATION,
