...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type6</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType6Impl#getSPECOBJECTTYPEREF <em>
 * SPECOBJECTTYPEREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TYPEType6Impl extends EObjectImpl implements TYPEType6 {
	...
	public void setSPECOBJECTTYPEREF(String newSPECOBJECTTYPEREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE6__SPECOBJECTTYPEREF, oldSPECOBJECTTYPEREF,
					sPECOBJECTTYPEREF));
		}
	}
