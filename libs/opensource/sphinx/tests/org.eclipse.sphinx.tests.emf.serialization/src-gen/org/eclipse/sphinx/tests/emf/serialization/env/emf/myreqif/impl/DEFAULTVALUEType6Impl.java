...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type6</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUEType6Impl#getATTRIBUTEVALUEBOOLEAN
 * <em>ATTRIBUTEVALUEBOOLEAN</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType6Impl extends EObjectImpl implements DEFAULTVALUEType6 {
	/**
	 * The cached value of the '{@link #getATTRIBUTEVALUEBOOLEAN() <em>ATTRIBUTEVALUEBOOLEAN</em>}' containment
	...
	public NotificationChain basicSetATTRIBUTEVALUEBOOLEAN(ATTRIBUTEVALUEBOOLEAN newATTRIBUTEVALUEBOOLEAN, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN,
					oldATTRIBUTEVALUEBOOLEAN, newATTRIBUTEVALUEBOOLEAN);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEBOOLEAN(ATTRIBUTEVALUEBOOLEAN newATTRIBUTEVALUEBOOLEAN) {
		if (newATTRIBUTEVALUEBOOLEAN != aTTRIBUTEVALUEBOOLEAN) {
			...
			if (aTTRIBUTEVALUEBOOLEAN != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEBOOLEAN).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, null, msgs);
			}
			if (newATTRIBUTEVALUEBOOLEAN != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEBOOLEAN).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, newATTRIBUTEVALUEBOOLEAN,
					newATTRIBUTEVALUEBOOLEAN));
		}
	}
