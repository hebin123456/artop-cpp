...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>ATTRIBUTEVALUEBOOLEAN</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.ATTRIBUTEVALUEBOOLEAN#getDEFINITION <em>DEFINITION
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.ATTRIBUTEVALUEBOOLEAN#isTHEVALUE <em>THEVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getATTRIBUTEVALUEBOOLEAN()
...
public interface ATTRIBUTEVALUEBOOLEAN extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getATTRIBUTEVALUEBOOLEAN_DEFINITION()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getATTRIBUTEVALUEBOOLEAN_THEVALUE()
