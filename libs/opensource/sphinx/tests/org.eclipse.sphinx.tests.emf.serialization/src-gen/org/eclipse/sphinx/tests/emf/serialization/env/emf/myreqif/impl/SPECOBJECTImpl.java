...
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECOBJECT;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SPECOBJECT</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getALTERNATIVEID <em>ALTERNATIVEID
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getVALUES <em>VALUES</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getTYPE <em>TYPE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getIDENTIFIER <em>IDENTIFIER</em>}
 * </li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getLASTCHANGE <em>LASTCHANGE</em>}
 * </li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTImpl#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECOBJECTImpl extends EObjectImpl implements SPECOBJECT {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType13 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECOBJECT__ALTERNATIVEID,
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType13 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECT__ALTERNATIVEID,
						null, msgs);
			}
			if (newALTERNATIVEID != null) {
				msgs = ((InternalEObject) newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECT__ALTERNATIVEID,
						null, msgs);
			}
