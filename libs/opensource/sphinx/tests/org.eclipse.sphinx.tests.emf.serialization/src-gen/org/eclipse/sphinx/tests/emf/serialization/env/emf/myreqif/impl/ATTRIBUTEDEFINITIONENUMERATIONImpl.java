...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEDEFINITIONENUMERATION</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getDEFAULTVALUE
 * <em>DEFAULTVALUE</em>}</li>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getALTERNATIVEID
 * <em>ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getTYPE <em>
 * TYPE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getDESC <em>
 * DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getIDENTIFIER
 * <em>IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#isISEDITABLE
 * <em>ISEDITABLE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getLASTCHANGE
 * <em>LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#getLONGNAME
 * <em>LONGNAME</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONENUMERATIONImpl#isMULTIVALUED
 * <em>MULTIVALUED</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ATTRIBUTEDEFINITIONENUMERATIONImpl extends EObjectImpl implements ATTRIBUTEDEFINITIONENUMERATION {
	...
	/**
	 * The default value of the '{@link #isMULTIVALUED() <em>MULTIVALUED</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isMULTIVALUED()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isMULTIVALUED() <em>MULTIVALUED</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isMULTIVALUED()
	 * @generated
	...
	/**
	 * This is true if the MULTIVALUED attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	public NotificationChain basicSetDEFAULTVALUE(DEFAULTVALUEType1 newDEFAULTVALUE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__DEFAULTVALUE, oldDEFAULTVALUE, newDEFAULTVALUE);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDEFAULTVALUE != dEFAULTVALUE) {
			...
			if (dEFAULTVALUE != null) {
				msgs = ((InternalEObject) dEFAULTVALUE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__DEFAULTVALUE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__DEFAULTVALUE, newDEFAULTVALUE,
					newDEFAULTVALUE));
		}
	}
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType20 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
	...
	public NotificationChain basicSetTYPE(TYPEType9 newTYPE, NotificationChain msgs) {
		...
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__TYPE,
					oldTYPE, newTYPE);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTYPE(TYPEType9 newTYPE) {
		if (newTYPE != tYPE) {
			NotificationChain msgs = null;
			if (tYPE != null) {
				msgs = ((InternalEObject) tYPE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__TYPE,
						null, msgs);
			}
			if (newTYPE != null) {
				msgs = ((InternalEObject) newTYPE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__TYPE,
						null, msgs);
			}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__IDENTIFIER, oldIDENTIFIER,
					iDENTIFIER));
		}
	}
	...
	public void setISEDITABLE(boolean newISEDITABLE) {
		...
		iSEDITABLEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__ISEDITABLE, oldISEDITABLE,
					iSEDITABLE, !oldISEDITABLEESet));
		}
	}
	...
	public void unsetISEDITABLE() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__ISEDITABLE, oldISEDITABLE,
	...
	public void setLASTCHANGE(XMLGregorianCalendar newLASTCHANGE) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__LASTCHANGE, oldLASTCHANGE,
					lASTCHANGE));
		}
	}
	...
	public void setMULTIVALUED(boolean newMULTIVALUED) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__MULTIVALUED, oldMULTIVALUED,
	...
	public void unsetMULTIVALUED() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEDEFINITIONENUMERATION__MULTIVALUED, oldMULTIVALUED,
					MULTIVALUED_EDEFAULT, oldMULTIVALUEDESet));
		}
	}
