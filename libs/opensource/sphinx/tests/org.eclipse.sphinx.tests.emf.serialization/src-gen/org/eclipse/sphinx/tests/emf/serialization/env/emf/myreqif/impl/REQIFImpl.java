...
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.REQIF;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>REQIF</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.REQIFImpl#getTHEHEADER <em>THEHEADER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.REQIFImpl#getCORECONTENT <em>CORECONTENT</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.REQIFImpl#getTOOLEXTENSIONS <em>TOOLEXTENSIONS
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.REQIFImpl#getLang <em>Lang</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class REQIFImpl extends EObjectImpl implements REQIF {
	/**
	 * The cached value of the '{@link #getTHEHEADER() <em>THEHEADER</em>}' containment reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getTHEHEADER()
	 * @generated
	...
	public NotificationChain basicSetTHEHEADER(THEHEADERType newTHEHEADER, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.REQIF__THEHEADER, oldTHEHEADER,
					newTHEHEADER);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public NotificationChain basicSetCORECONTENT(CORECONTENTType newCORECONTENT, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.REQIF__CORECONTENT, oldCORECONTENT,
					newCORECONTENT);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public NotificationChain basicSetTOOLEXTENSIONS(TOOLEXTENSIONSType newTOOLEXTENSIONS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.REQIF__TOOLEXTENSIONS, oldTOOLEXTENSIONS,
					newTOOLEXTENSIONS);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTOOLEXTENSIONS(TOOLEXTENSIONSType newTOOLEXTENSIONS) {
		if (newTOOLEXTENSIONS != tOOLEXTENSIONS) {
			...
			if (tOOLEXTENSIONS != null) {
				msgs = ((InternalEObject) tOOLEXTENSIONS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.REQIF__TOOLEXTENSIONS, null,
						msgs);
			}
			if (newTOOLEXTENSIONS != null) {
				msgs = ((InternalEObject) newTOOLEXTENSIONS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.REQIF__TOOLEXTENSIONS, null,
						msgs);
			}
