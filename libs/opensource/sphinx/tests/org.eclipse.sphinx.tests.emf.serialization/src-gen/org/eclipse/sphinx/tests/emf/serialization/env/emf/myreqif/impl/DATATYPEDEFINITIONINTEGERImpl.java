...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DATATYPEDEFINITIONINTEGER</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getALTERNATIVEID
 * <em>ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getDESC <em>DESC
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getIDENTIFIER <em>
 * IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getLASTCHANGE <em>
 * LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getLONGNAME <em>
 * LONGNAME</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getMAX <em>MAX
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPEDEFINITIONINTEGERImpl#getMIN <em>MIN
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class DATATYPEDEFINITIONINTEGERImpl extends EObjectImpl implements DATATYPEDEFINITIONINTEGER {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType19 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONINTEGER__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DATATYPEDEFINITIONINTEGER__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONINTEGER__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
