...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>VALUES Type2</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEBOOLEAN <em>
 * ATTRIBUTEVALUEBOOLEAN</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEDATE <em>
 * ATTRIBUTEVALUEDATE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEENUMERATION <em>
 * ATTRIBUTEVALUEENUMERATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEINTEGER <em>
 * ATTRIBUTEVALUEINTEGER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEREAL <em>
 * ATTRIBUTEVALUEREAL</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUESTRING <em>
 * ATTRIBUTEVALUESTRING</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.VALUESType2Impl#getATTRIBUTEVALUEXHTML <em>
