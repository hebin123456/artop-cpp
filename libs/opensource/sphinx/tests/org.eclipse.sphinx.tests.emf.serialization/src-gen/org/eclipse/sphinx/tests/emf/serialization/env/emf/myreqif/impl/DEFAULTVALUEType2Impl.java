...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type2</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUEType2Impl#getATTRIBUTEVALUEINTEGER
 * <em>ATTRIBUTEVALUEINTEGER</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType2Impl extends EObjectImpl implements DEFAULTVALUEType2 {
	/**
	 * The cached value of the '{@link #getATTRIBUTEVALUEINTEGER() <em>ATTRIBUTEVALUEINTEGER</em>}' containment
	...
	public NotificationChain basicSetATTRIBUTEVALUEINTEGER(ATTRIBUTEVALUEINTEGER newATTRIBUTEVALUEINTEGER, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER,
					oldATTRIBUTEVALUEINTEGER, newATTRIBUTEVALUEINTEGER);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEINTEGER(ATTRIBUTEVALUEINTEGER newATTRIBUTEVALUEINTEGER) {
		if (newATTRIBUTEVALUEINTEGER != aTTRIBUTEVALUEINTEGER) {
			...
			if (aTTRIBUTEVALUEINTEGER != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEINTEGER).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, null, msgs);
			}
			if (newATTRIBUTEVALUEINTEGER != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEINTEGER).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, newATTRIBUTEVALUEINTEGER,
					newATTRIBUTEVALUEINTEGER));
		}
	}
