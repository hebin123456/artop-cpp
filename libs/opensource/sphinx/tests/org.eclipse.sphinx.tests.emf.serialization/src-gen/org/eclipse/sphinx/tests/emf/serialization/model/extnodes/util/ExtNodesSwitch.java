...
public class ExtNodesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExtNodesPackage.EXTENDED_NODE: {
			...
			if (result == null) {
				result = caseSubNode(extendedNode);
			}
			if (result == null) {
				result = caseNode(extendedNode);
			}
			if (result == null) {
				result = caseAbstractNode(extendedNode);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extended Node</em>'. <!-- begin-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Node</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sub Node</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
