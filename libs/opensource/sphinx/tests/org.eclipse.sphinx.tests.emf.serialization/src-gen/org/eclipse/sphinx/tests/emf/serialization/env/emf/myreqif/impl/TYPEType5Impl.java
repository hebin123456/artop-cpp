...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type5</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType5Impl#getDATATYPEDEFINITIONXHTMLREF <em>
...
public class TYPEType5Impl extends EObjectImpl implements TYPEType5 {
	/**
	 * The default value of the '{@link #getDATATYPEDEFINITIONXHTMLREF() <em>DATATYPEDEFINITIONXHTMLREF</em>}'
	...
	public void setDATATYPEDEFINITIONXHTMLREF(String newDATATYPEDEFINITIONXHTMLREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE5__DATATYPEDEFINITIONXHTMLREF,
					oldDATATYPEDEFINITIONXHTMLREF, dATATYPEDEFINITIONXHTMLREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.TYPE_TYPE5__DATATYPEDEFINITIONXHTMLREF:
			return DATATYPEDEFINITIONXHTMLREF_EDEFAULT == null ? dATATYPEDEFINITIONXHTMLREF != null : !DATATYPEDEFINITIONXHTMLREF_EDEFAULT
					.equals(dATATYPEDEFINITIONXHTMLREF);
		}
