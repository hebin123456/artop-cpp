...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFINITION Type6</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFINITIONType6Impl#getATTRIBUTEDEFINITIONBOOLEANREF
...
public class DEFINITIONType6Impl extends EObjectImpl implements DEFINITIONType6 {
	/**
	 * The default value of the '{@link #getATTRIBUTEDEFINITIONBOOLEANREF() <em>ATTRIBUTEDEFINITIONBOOLEANREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getATTRIBUTEDEFINITIONBOOLEANREF() <em>ATTRIBUTEDEFINITIONBOOLEANREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getATTRIBUTEDEFINITIONBOOLEANREF()
	 * @generated
	...
	public void setATTRIBUTEDEFINITIONBOOLEANREF(String newATTRIBUTEDEFINITIONBOOLEANREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFINITION_TYPE6__ATTRIBUTEDEFINITIONBOOLEANREF,
					oldATTRIBUTEDEFINITIONBOOLEANREF, aTTRIBUTEDEFINITIONBOOLEANREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.DEFINITION_TYPE6__ATTRIBUTEDEFINITIONBOOLEANREF:
			return ATTRIBUTEDEFINITIONBOOLEANREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONBOOLEANREF != null : !ATTRIBUTEDEFINITIONBOOLEANREF_EDEFAULT
					.equals(aTTRIBUTEDEFINITIONBOOLEANREF);
		}
