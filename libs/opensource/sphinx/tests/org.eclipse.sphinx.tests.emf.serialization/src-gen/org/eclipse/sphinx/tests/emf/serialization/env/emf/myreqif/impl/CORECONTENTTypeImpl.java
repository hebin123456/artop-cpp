...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>CORECONTENT Type</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.CORECONTENTTypeImpl#getREQIFCONTENT <em>
 * REQIFCONTENT</em>}</li>
 * </ul>
 * </p>
 *
...
public class CORECONTENTTypeImpl extends EObjectImpl implements CORECONTENTType {
	...
	public NotificationChain basicSetREQIFCONTENT(REQIFCONTENT newREQIFCONTENT, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.CORECONTENT_TYPE__REQIFCONTENT,
					oldREQIFCONTENT, newREQIFCONTENT);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setREQIFCONTENT(REQIFCONTENT newREQIFCONTENT) {
		if (newREQIFCONTENT != rEQIFCONTENT) {
			...
			if (rEQIFCONTENT != null) {
				msgs = ((InternalEObject) rEQIFCONTENT).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.CORECONTENT_TYPE__REQIFCONTENT,
						null, msgs);
			}
			if (newREQIFCONTENT != null) {
				msgs = ((InternalEObject) newREQIFCONTENT).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.CORECONTENT_TYPE__REQIFCONTENT,
						null, msgs);
			}
