...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SPECOBJECTTYPE</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getSPECATTRIBUTES <em>
 * SPECATTRIBUTES</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getIDENTIFIER <em>IDENTIFIER
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getLASTCHANGE <em>LASTCHANGE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.SPECOBJECTTYPEImpl#getLONGNAME <em>LONGNAME</em>}
 * </li>
 * </ul>
 * </p>
 *
...
public class SPECOBJECTTYPEImpl extends EObjectImpl implements SPECOBJECTTYPE {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType7 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECOBJECTTYPE__ALTERNATIVEID,
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType7 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECTTYPE__ALTERNATIVEID,
						null, msgs);
			}
			if (newALTERNATIVEID != null) {
				msgs = ((InternalEObject) newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECTTYPE__ALTERNATIVEID,
						null, msgs);
			}
	...
	public NotificationChain basicSetSPECATTRIBUTES(SPECATTRIBUTESType2 newSPECATTRIBUTES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECOBJECTTYPE__SPECATTRIBUTES,
	...
	public void setSPECATTRIBUTES(SPECATTRIBUTESType2 newSPECATTRIBUTES) {
		if (newSPECATTRIBUTES != sPECATTRIBUTES) {
			...
			if (sPECATTRIBUTES != null) {
				msgs = ((InternalEObject) sPECATTRIBUTES).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECTTYPE__SPECATTRIBUTES, null, msgs);
			}
			if (newSPECATTRIBUTES != null) {
				msgs = ((InternalEObject) newSPECATTRIBUTES).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECOBJECTTYPE__SPECATTRIBUTES, null, msgs);
			}
