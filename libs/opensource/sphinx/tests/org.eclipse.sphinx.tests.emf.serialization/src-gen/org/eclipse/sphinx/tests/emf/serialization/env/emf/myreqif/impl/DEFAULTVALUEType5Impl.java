...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFAULTVALUE Type5</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFAULTVALUEType5Impl#getATTRIBUTEVALUEXHTML <em>
...
public class DEFAULTVALUEType5Impl extends EObjectImpl implements DEFAULTVALUEType5 {
	...
	public NotificationChain basicSetATTRIBUTEVALUEXHTML(ATTRIBUTEVALUEXHTML newATTRIBUTEVALUEXHTML, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE5__ATTRIBUTEVALUEXHTML,
					oldATTRIBUTEVALUEXHTML, newATTRIBUTEVALUEXHTML);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setATTRIBUTEVALUEXHTML(ATTRIBUTEVALUEXHTML newATTRIBUTEVALUEXHTML) {
		if (newATTRIBUTEVALUEXHTML != aTTRIBUTEVALUEXHTML) {
			...
			if (aTTRIBUTEVALUEXHTML != null) {
				msgs = ((InternalEObject) aTTRIBUTEVALUEXHTML).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE5__ATTRIBUTEVALUEXHTML, null, msgs);
			}
			if (newATTRIBUTEVALUEXHTML != null) {
				msgs = ((InternalEObject) newATTRIBUTEVALUEXHTML).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.DEFAULTVALUE_TYPE5__ATTRIBUTEVALUEXHTML, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFAULTVALUE_TYPE5__ATTRIBUTEVALUEXHTML, newATTRIBUTEVALUEXHTML,
					newATTRIBUTEVALUEXHTML));
		}
	}
