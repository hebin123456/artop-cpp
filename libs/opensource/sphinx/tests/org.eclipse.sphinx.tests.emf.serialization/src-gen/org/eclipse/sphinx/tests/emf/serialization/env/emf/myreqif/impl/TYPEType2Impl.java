...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type2</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType2Impl#getDATATYPEDEFINITIONINTEGERREF
 * <em>DATATYPEDEFINITIONINTEGERREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TYPEType2Impl extends EObjectImpl implements TYPEType2 {
	/**
	 * The default value of the '{@link #getDATATYPEDEFINITIONINTEGERREF() <em>DATATYPEDEFINITIONINTEGERREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getDATATYPEDEFINITIONINTEGERREF() <em>DATATYPEDEFINITIONINTEGERREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDATATYPEDEFINITIONINTEGERREF()
	 * @generated
	...
	public void setDATATYPEDEFINITIONINTEGERREF(String newDATATYPEDEFINITIONINTEGERREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE2__DATATYPEDEFINITIONINTEGERREF,
					oldDATATYPEDEFINITIONINTEGERREF, dATATYPEDEFINITIONINTEGERREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.TYPE_TYPE2__DATATYPEDEFINITIONINTEGERREF:
			return DATATYPEDEFINITIONINTEGERREF_EDEFAULT == null ? dATATYPEDEFINITIONINTEGERREF != null : !DATATYPEDEFINITIONINTEGERREF_EDEFAULT
