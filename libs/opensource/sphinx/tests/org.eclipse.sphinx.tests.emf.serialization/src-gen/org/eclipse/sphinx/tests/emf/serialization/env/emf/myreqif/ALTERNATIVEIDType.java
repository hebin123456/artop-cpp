...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>ALTERNATIVEID Type</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.ALTERNATIVEIDType#getALTERNATIVEID <em>ALTERNATIVEID
 * </em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getALTERNATIVEIDType()
...
public interface ALTERNATIVEIDType extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getALTERNATIVEIDType_ALTERNATIVEID()
