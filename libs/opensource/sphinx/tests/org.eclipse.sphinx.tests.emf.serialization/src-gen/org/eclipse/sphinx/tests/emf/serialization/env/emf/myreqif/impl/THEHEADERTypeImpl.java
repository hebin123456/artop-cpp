...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>THEHEADER Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.THEHEADERTypeImpl#getREQIFHEADER <em>REQIFHEADER
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class THEHEADERTypeImpl extends EObjectImpl implements THEHEADERType {
	...
	public NotificationChain basicSetREQIFHEADER(REQIFHEADER newREQIFHEADER, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.THEHEADER_TYPE__REQIFHEADER,
					oldREQIFHEADER, newREQIFHEADER);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setREQIFHEADER(REQIFHEADER newREQIFHEADER) {
		if (newREQIFHEADER != rEQIFHEADER) {
			...
			if (rEQIFHEADER != null) {
				msgs = ((InternalEObject) rEQIFHEADER).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.THEHEADER_TYPE__REQIFHEADER,
						null, msgs);
			}
			if (newREQIFHEADER != null) {
				msgs = ((InternalEObject) newREQIFHEADER).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.THEHEADER_TYPE__REQIFHEADER,
						null, msgs);
			}
