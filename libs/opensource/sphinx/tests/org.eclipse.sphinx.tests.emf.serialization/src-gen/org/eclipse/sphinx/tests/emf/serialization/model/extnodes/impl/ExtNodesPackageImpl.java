...
public class ExtNodesPackageImpl extends EPackageImpl implements ExtNodesPackage {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.model.extnodes.ExtNodesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * <p>
	 * This method is used to initialize {@link ExtNodesPackage#eINSTANCE} when that field is accessed. Clients should
	...
	public static ExtNodesPackage init() {
		...
		ExtNodesPackageImpl theExtNodesPackage = (ExtNodesPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ExtNodesPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new ExtNodesPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getExtendedNode_AltenativeName(), ecorePackage.getEString(), "altenativeName", null, 0, 1, ExtendedNode.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(extensionEClass, Extension.class, "Extension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExtension_Extensions(), getExtendedNode(), null, "extensions", null, 0, -1, Extension.class, !IS_TRANSIENT, !IS_VOLATILE,
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getExtension_Extensions(), source, new String[] { "namespace", "##targetNamespace" });
	}
