...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEDEFINITIONXHTML</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getALTERNATIVEID
 * <em>ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getDEFAULTVALUE <em>
 * DEFAULTVALUE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getTYPE <em>TYPE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getDESC <em>DESC
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getIDENTIFIER <em>
 * IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#isISEDITABLE <em>
 * ISEDITABLE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getLASTCHANGE <em>
 * LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEDEFINITIONXHTMLImpl#getLONGNAME <em>
 * LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
...
public class ATTRIBUTEDEFINITIONXHTMLImpl extends EObjectImpl implements ATTRIBUTEDEFINITIONXHTML {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType6 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__ALTERNATIVEID,
		...
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null) {
				msgs = ((InternalEObject) aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__ALTERNATIVEID, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__ALTERNATIVEID, newALTERNATIVEID,
					newALTERNATIVEID));
		}
	}
	...
	public NotificationChain basicSetDEFAULTVALUE(DEFAULTVALUEType5 newDEFAULTVALUE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__DEFAULTVALUE,
		...
		if (newDEFAULTVALUE != dEFAULTVALUE) {
			...
			if (dEFAULTVALUE != null) {
				msgs = ((InternalEObject) dEFAULTVALUE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__DEFAULTVALUE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__DEFAULTVALUE, newDEFAULTVALUE,
					newDEFAULTVALUE));
		}
	}
	...
	public NotificationChain basicSetTYPE(TYPEType5 newTYPE, NotificationChain msgs) {
		...
		tYPE = newTYPE;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__TYPE, oldTYPE,
					newTYPE);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTYPE(TYPEType5 newTYPE) {
		if (newTYPE != tYPE) {
			NotificationChain msgs = null;
			if (tYPE != null) {
				msgs = ((InternalEObject) tYPE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__TYPE, null,
						msgs);
			}
			if (newTYPE != null) {
				msgs = ((InternalEObject) newTYPE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__TYPE, null,
						msgs);
			}
	...
	public void setISEDITABLE(boolean newISEDITABLE) {
		...
		iSEDITABLEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__ISEDITABLE, oldISEDITABLE, iSEDITABLE,
					!oldISEDITABLEESet));
		}
	}
	...
	public void unsetISEDITABLE() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEDEFINITIONXHTML__ISEDITABLE, oldISEDITABLE,
