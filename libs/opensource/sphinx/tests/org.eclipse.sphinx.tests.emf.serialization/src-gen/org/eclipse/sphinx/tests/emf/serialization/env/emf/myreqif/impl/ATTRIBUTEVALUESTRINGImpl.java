...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEVALUESTRING</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUESTRINGImpl#getDEFINITION <em>
 * DEFINITION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUESTRINGImpl#getTHEVALUE <em>THEVALUE
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class ATTRIBUTEVALUESTRINGImpl extends EObjectImpl implements ATTRIBUTEVALUESTRING {
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType2 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEVALUESTRING__DEFINITION,
	...
	public void setDEFINITION(DEFINITIONType2 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null) {
				msgs = ((InternalEObject) dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUESTRING__DEFINITION,
						null, msgs);
			}
			if (newDEFINITION != null) {
				msgs = ((InternalEObject) newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUESTRING__DEFINITION,
						null, msgs);
			}
