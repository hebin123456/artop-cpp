...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFINITION Type2</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFINITIONType2Impl#getATTRIBUTEDEFINITIONSTRINGREF
...
public class DEFINITIONType2Impl extends EObjectImpl implements DEFINITIONType2 {
	/**
	 * The default value of the '{@link #getATTRIBUTEDEFINITIONSTRINGREF() <em>ATTRIBUTEDEFINITIONSTRINGREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getATTRIBUTEDEFINITIONSTRINGREF() <em>ATTRIBUTEDEFINITIONSTRINGREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getATTRIBUTEDEFINITIONSTRINGREF()
	 * @generated
	...
	public void setATTRIBUTEDEFINITIONSTRINGREF(String newATTRIBUTEDEFINITIONSTRINGREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFINITION_TYPE2__ATTRIBUTEDEFINITIONSTRINGREF,
					oldATTRIBUTEDEFINITIONSTRINGREF, aTTRIBUTEDEFINITIONSTRINGREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.DEFINITION_TYPE2__ATTRIBUTEDEFINITIONSTRINGREF:
			return ATTRIBUTEDEFINITIONSTRINGREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONSTRINGREF != null : !ATTRIBUTEDEFINITIONSTRINGREF_EDEFAULT
					.equals(aTTRIBUTEDEFINITIONSTRINGREF);
		}
