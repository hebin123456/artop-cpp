...
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONDATE;
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONENUMERATION;
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER;
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONREAL;
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONSTRING;
import org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONXHTML;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DATATYPES Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONBOOLEAN
 * <em>DATATYPEDEFINITIONBOOLEAN</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONDATE <em>
 * DATATYPEDEFINITIONDATE</em>}</li>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONENUMERATION
 * <em>DATATYPEDEFINITIONENUMERATION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONINTEGER
 * <em>DATATYPEDEFINITIONINTEGER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONREAL <em>
 * DATATYPEDEFINITIONREAL</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONSTRING
 * <em>DATATYPEDEFINITIONSTRING</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DATATYPESTypeImpl#getDATATYPEDEFINITIONXHTML <em>
