...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEVALUEBOOLEAN</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUEBOOLEANImpl#getDEFINITION <em>
 * DEFINITION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUEBOOLEANImpl#isTHEVALUE <em>THEVALUE
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class ATTRIBUTEVALUEBOOLEANImpl extends EObjectImpl implements ATTRIBUTEVALUEBOOLEAN {
	...
	/**
	 * The default value of the '{@link #isTHEVALUE() <em>THEVALUE</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isTHEVALUE()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isTHEVALUE() <em>THEVALUE</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isTHEVALUE()
	 * @generated
	...
	/**
	 * This is true if the THEVALUE attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType6 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION,
	...
	public void setDEFINITION(DEFINITIONType6 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null) {
				msgs = ((InternalEObject) dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION,
						null, msgs);
			}
			if (newDEFINITION != null) {
				msgs = ((InternalEObject) newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION,
						null, msgs);
			}
	...
	public void setTHEVALUE(boolean newTHEVALUE) {
		...
		tHEVALUEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEVALUEBOOLEAN__THEVALUE, oldTHEVALUE, tHEVALUE,
					!oldTHEVALUEESet));
		}
	}
	...
	public void unsetTHEVALUE() {
		...
		tHEVALUEESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEVALUEBOOLEAN__THEVALUE, oldTHEVALUE, THEVALUE_EDEFAULT,
					oldTHEVALUEESet));
		}
	}
