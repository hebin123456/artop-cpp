...
public interface NodesFactory extends EFactory {
	 ...
	 * @generated
	 */
	NodesFactory eINSTANCE = org.eclipse.sphinx.tests.emf.serialization.model.nodes.impl.NodesFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Sub Node</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
