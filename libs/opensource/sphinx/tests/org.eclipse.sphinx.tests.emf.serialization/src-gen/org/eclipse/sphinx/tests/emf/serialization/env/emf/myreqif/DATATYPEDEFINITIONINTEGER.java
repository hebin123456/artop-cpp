...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>DATATYPEDEFINITIONINTEGER</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getALTERNATIVEID <em>
 * ALTERNATIVEID</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getIDENTIFIER <em>IDENTIFIER
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getLASTCHANGE <em>LASTCHANGE
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getLONGNAME <em>LONGNAME
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getMAX <em>MAX</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.DATATYPEDEFINITIONINTEGER#getMIN <em>MIN</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER()
...
public interface DATATYPEDEFINITIONINTEGER extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_ALTERNATIVEID()
	 ...
	 * @see #setDESC(String)
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_DESC()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_IDENTIFIER()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_LASTCHANGE()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_LONGNAME()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_MAX()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getDATATYPEDEFINITIONINTEGER_MIN()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" required="true"
