...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFINITION Type1</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFINITIONType1Impl#getATTRIBUTEDEFINITIONDATEREF
...
public class DEFINITIONType1Impl extends EObjectImpl implements DEFINITIONType1 {
	/**
	 * The default value of the '{@link #getATTRIBUTEDEFINITIONDATEREF() <em>ATTRIBUTEDEFINITIONDATEREF</em>}'
	...
	public void setATTRIBUTEDEFINITIONDATEREF(String newATTRIBUTEDEFINITIONDATEREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFINITION_TYPE1__ATTRIBUTEDEFINITIONDATEREF,
					oldATTRIBUTEDEFINITIONDATEREF, aTTRIBUTEDEFINITIONDATEREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.DEFINITION_TYPE1__ATTRIBUTEDEFINITIONDATEREF:
			return ATTRIBUTEDEFINITIONDATEREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONDATEREF != null : !ATTRIBUTEDEFINITIONDATEREF_EDEFAULT
					.equals(aTTRIBUTEDEFINITIONDATEREF);
		}
