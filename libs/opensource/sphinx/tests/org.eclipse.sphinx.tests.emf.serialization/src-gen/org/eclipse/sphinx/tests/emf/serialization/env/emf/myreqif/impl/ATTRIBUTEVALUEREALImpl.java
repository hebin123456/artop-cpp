...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>ATTRIBUTEVALUEREAL</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUEREALImpl#getDEFINITION <em>
 * DEFINITION</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.ATTRIBUTEVALUEREALImpl#getTHEVALUE <em>THEVALUE
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class ATTRIBUTEVALUEREALImpl extends EObjectImpl implements ATTRIBUTEVALUEREAL {
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType4 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEVALUEREAL__DEFINITION,
	...
	public void setDEFINITION(DEFINITIONType4 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null) {
				msgs = ((InternalEObject) dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUEREAL__DEFINITION,
						null, msgs);
			}
			if (newDEFINITION != null) {
				msgs = ((InternalEObject) newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ATTRIBUTEVALUEREAL__DEFINITION,
						null, msgs);
			}
	...
	public void setTHEVALUE(double newTHEVALUE) {
		...
		tHEVALUEESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.ATTRIBUTEVALUEREAL__THEVALUE, oldTHEVALUE, tHEVALUE,
					!oldTHEVALUEESet));
		}
	}
	...
	public void unsetTHEVALUE() {
		...
		tHEVALUEESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, MyreqifPackage.ATTRIBUTEVALUEREAL__THEVALUE, oldTHEVALUE, THEVALUE_EDEFAULT,
					oldTHEVALUEESet));
		}
	}
