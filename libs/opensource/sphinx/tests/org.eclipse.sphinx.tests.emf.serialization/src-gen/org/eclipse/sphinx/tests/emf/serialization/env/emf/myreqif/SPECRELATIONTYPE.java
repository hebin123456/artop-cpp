...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>SPECRELATIONTYPE</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getALTERNATIVEID <em>ALTERNATIVEID
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getSPECATTRIBUTES <em>SPECATTRIBUTES
 * </em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getDESC <em>DESC</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getIDENTIFIER <em>IDENTIFIER</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getLASTCHANGE <em>LASTCHANGE</em>}</li>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE()
...
public interface SPECRELATIONTYPE extends EObject {
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_ALTERNATIVEID()
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_SPECATTRIBUTES()
	 ...
	 * @see #setDESC(String)
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_DESC()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getDESC
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_IDENTIFIER()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getIDENTIFIER
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_LASTCHANGE()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getLASTCHANGE
	 ...
	 * @see org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.MyreqifPackage#getSPECRELATIONTYPE_LONGNAME()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.SPECRELATIONTYPE#getLONGNAME
