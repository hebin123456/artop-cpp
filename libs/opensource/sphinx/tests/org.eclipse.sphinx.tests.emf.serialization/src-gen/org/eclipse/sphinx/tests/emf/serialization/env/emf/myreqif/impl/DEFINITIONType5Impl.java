...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFINITION Type5</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFINITIONType5Impl#getATTRIBUTEDEFINITIONINTEGERREF
...
public class DEFINITIONType5Impl extends EObjectImpl implements DEFINITIONType5 {
	/**
	 * The default value of the '{@link #getATTRIBUTEDEFINITIONINTEGERREF() <em>ATTRIBUTEDEFINITIONINTEGERREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getATTRIBUTEDEFINITIONINTEGERREF() <em>ATTRIBUTEDEFINITIONINTEGERREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getATTRIBUTEDEFINITIONINTEGERREF()
	 * @generated
	...
	public void setATTRIBUTEDEFINITIONINTEGERREF(String newATTRIBUTEDEFINITIONINTEGERREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFINITION_TYPE5__ATTRIBUTEDEFINITIONINTEGERREF,
					oldATTRIBUTEDEFINITIONINTEGERREF, aTTRIBUTEDEFINITIONINTEGERREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.DEFINITION_TYPE5__ATTRIBUTEDEFINITIONINTEGERREF:
			return ATTRIBUTEDEFINITIONINTEGERREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONINTEGERREF != null : !ATTRIBUTEDEFINITIONINTEGERREF_EDEFAULT
					.equals(aTTRIBUTEDEFINITIONINTEGERREF);
		}
