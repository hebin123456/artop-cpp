...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TYPE Type4</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.TYPEType4Impl#getDATATYPEDEFINITIONREALREF <em>
 * DATATYPEDEFINITIONREALREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TYPEType4Impl extends EObjectImpl implements TYPEType4 {
	...
	public void setDATATYPEDEFINITIONREALREF(String newDATATYPEDEFINITIONREALREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TYPE_TYPE4__DATATYPEDEFINITIONREALREF, oldDATATYPEDEFINITIONREALREF,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.TYPE_TYPE4__DATATYPEDEFINITIONREALREF:
			return DATATYPEDEFINITIONREALREF_EDEFAULT == null ? dATATYPEDEFINITIONREALREF != null : !DATATYPEDEFINITIONREALREF_EDEFAULT
