...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>DEFINITION Type3</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sphinx.tests.emf.serialization.env.emf.myreqif.impl.DEFINITIONType3Impl#getATTRIBUTEDEFINITIONXHTMLREF
...
public class DEFINITIONType3Impl extends EObjectImpl implements DEFINITIONType3 {
	/**
	 * The default value of the '{@link #getATTRIBUTEDEFINITIONXHTMLREF() <em>ATTRIBUTEDEFINITIONXHTMLREF</em>}'
	...
	/**
	 * The cached value of the '{@link #getATTRIBUTEDEFINITIONXHTMLREF() <em>ATTRIBUTEDEFINITIONXHTMLREF</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getATTRIBUTEDEFINITIONXHTMLREF()
	 * @generated
	...
	public void setATTRIBUTEDEFINITIONXHTMLREF(String newATTRIBUTEDEFINITIONXHTMLREF) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DEFINITION_TYPE3__ATTRIBUTEDEFINITIONXHTMLREF,
					oldATTRIBUTEDEFINITIONXHTMLREF, aTTRIBUTEDEFINITIONXHTMLREF));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MyreqifPackage.DEFINITION_TYPE3__ATTRIBUTEDEFINITIONXHTMLREF:
			return ATTRIBUTEDEFINITIONXHTMLREF_EDEFAULT == null ? aTTRIBUTEDEFINITIONXHTMLREF != null : !ATTRIBUTEDEFINITIONXHTMLREF_EDEFAULT
					.equals(aTTRIBUTEDEFINITIONXHTMLREF);
		}
